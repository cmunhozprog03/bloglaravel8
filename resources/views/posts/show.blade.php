<x-app-layout>
  ...
  <div class="container py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <aside>
        <h1 class="text-2xl text-gray-600 font-semibold mb-4">Mais em {{ $post->category->name }}</h1>
        <ul>
          @foreach ($similares as $similar)
            <li class="mb-4">
              <a class="flex" href="{{ route('posts.show', $similar) }}">
                ...
                @else
                  <img class="h-20 w-30 object-cover object-center" src="https://cdn.pixabay.com/photo/2020/09/29/23/50/windmills-5614160_960_720.jpg" alt="">  
                @endif
