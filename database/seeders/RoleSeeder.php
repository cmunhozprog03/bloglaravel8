...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.categoires.index'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'admin.categoires.create'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'admin.categoires.edit'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'admin.categoires.destroy'])->syncRoles([$role1, $role2]);
